...
import UserGithubTab from "../../client/containers/UserDetailPage/UserGithubTab";
...
describe("UserGithubTab", () => {
  const props = {
    data: {
      ...{ ...mockStore.dashboardData.userDetail.github }
    }
  };
  const wrapper = mount(<UserGithubTab {...props} />);
